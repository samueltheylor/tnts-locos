...
NAMES = ["mega_tnt", "mini_tnt", "lava_tnt", "rapida_tnt", "hielo_tnt",
         ...
         "luck_tnt", "portal_tnt",
         "acidic_tnt", "animal_tnt", "cannon_tnt", "catalyst_tnt", "chicxulub_tnt", "continental_tnt", "custom_tnt", "deimos_tnt", "dense_tnt", "dust_bowl_tnt", "end_gate_tnt", "firestorm_tnt", "flower_tnt", "ghost_tnt", "giant_tnt", "global_tnt", "gotthard_tnt", "heat_death_tnt", "heavens_gate_tnt", "hells_gate_tnt", "hexahedron_tnt", "hungry_tnt", "hyperion_tnt", "ice_age_tnt", "icy_tnt", "knockback_tnt", "leaping_tnt", "levitating_tnt", "lightning_storm_tnt", "lucky_god_tnt", "mankind_tnt", "midas_tnt", "mineral_tnt", "mountaintop_tnt", "particle_tnt", "plantation_tnt", "pompeii_tnt", "poseidon_tnt", "present_tnt", "pulsar_tnt", "reset_tnt", "reversed_tnt", "roulette_tnt", "sinkhole_tnt", "snowstorm_tnt", "squaring_tnt", "tetrahedron_tnt", "revolution_tnt", "tnt_x2000", "toxic_clouds_tnt", "tsar_bomba_tnt", "unbreakable_tnt", "vicious_tnt", "wither_storm_tnt", "world_wools_tnt", "aether_tnt", "asteroid_tnt", "atlantis_tnt", "city_firework_tnt", "compressed_tnt", "death_ray_tnt", "disintegrating_tnt", "doomsday_tnt", "evil_tnt", "extinction_tnt", "fiery_hell_tnt", "flak_tnt", "flat_earth_tnt", "fluorine_tnt", "flying_tnt", "grande_finale_tnt", "heat_wave_tnt", "helix_tnt", "hydrogen_bomb_tnt", "illuminati_tnt", "jumping_tnt", "kola_borehole_tnt", "lucky_doomsday_tnt", "meteor_storm_tnt", "nether_tnt", "phobos_tnt", "solar_eruption_tnt", "stone_cold_tnt", "structure_tnt", "tnt_rain_tnt", "tnt_x10000", "vredefort_tnt", "wasteland_tnt", "winter_tnt", "dynamite", "accelerating_dynamite", "animal_dynamite", "arrow_dynamite", "big_dynamite", "bouncing_dynamite", "chemical_dynamite", "christmas_dynamite", "cluster_dynamite", "compact_dynamite", "cubic_dynamite", "digging_dynamite", "dripstone_dynamite", "dynamite_firework", "dynamite_x5", "dynamite_x20", "dynamite_x100", "dynamite_x500", "end_dynamite", "ender_dynamite", "erupting_dynamite", "farming_dynamite", "fire_dynamite", "flat_dynamite", "floating_dynamite", "floating_island_dynamite", "freeze_dynamite", "gravity_dynamite", "grove_dynamite", "hellfire_dynamite", "homing_dynamite", "honey_dynamite", "ice_meteor_dynamite", "igniter_dynamite", "lava_ocean_dynamite", "lightning_dynamite", "lucky_dynamite", "lush_dynamite", "meteor_dynamite", "miningflat_dynamite", "multiplying_dynamite", "nether_grove_dynamite", "nuclear_dynamite", "nuclear_waste_dynamite", "ocean_dynamite", "physics_dynamite", "picky_dynamite", "prism_dynamite", "pulse_dynamite", "rainbow_dynamite", "random_dynamite", "reaction_dynamite", "ring_dynamite", "roulette_dynamite", "sculk_dynamite", "sensor_dynamite", "shatterproof_dynamite", "snow_dynamite", "sphere_dynamite", "spiral_dynamite", "timer_dynamite", "tunneling_dynamite", "ultralight_dynamite", "vaporize_dynamite", "withering_dynamite", "wool_dynamite", "xray_dynamite"]
...
PALETTES = {
    ...
    "acidic_tnt": ("#65a30d", "#d9f99d", "#365314", "#84cc16", "#365314"),
    "animal_tnt": ("#92400e", "#fef3c7", "#451a03", "#d97706", "#451a03"),
    "cannon_tnt": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "catalyst_tnt": ("#9f1239", "#ffe4e6", "#4c0519", "#fb7185", "#4c0519"),
    "chicxulub_tnt": ("#78350f", "#fef3c7", "#1c1917", "#fde047", "#1c1917"),
    "continental_tnt": ("#78350f", "#fef3c7", "#451a03", "#a16207", "#451a03"),
    "custom_tnt": ("#7f1d1d", "#f5f5f4", "#450a0a", "#ef4444", "#450a0a"),
    "deimos_tnt": ("#1c1917", "#f97316", "#0a0a0a", "#fb923c", "#0a0a0a"),
    "dense_tnt": ("#292524", "#f5f5f4", "#0a0a0a", "#d6d3d1", "#0a0a0a"),
    "dust_bowl_tnt": ("#ca8a04", "#fef9c3", "#713f12", "#fde047", "#713f12"),
    "end_gate_tnt": ("#4c1d95", "#f5f3ff", "#2e1065", "#d8b4fe", "#2e1065"),
    "firestorm_tnt": ("#9a3412", "#fde047", "#450a0a", "#f97316", "#450a0a"),
    "flower_tnt": ("#16a34a", "#dcfce7", "#14532d", "#4ade80", "#14532d"),
    "ghost_tnt": ("#e2e8f0", "#ffffff", "#64748b", "#f1f5f9", "#64748b"),
    "giant_tnt": ("#dc2626", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "global_tnt": ("#0f172a", "#fde047", "#020617", "#facc15", "#020617"),
    "gotthard_tnt": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "heat_death_tnt": ("#1c1917", "#ef4444", "#0a0a0a", "#dc2626", "#0a0a0a"),
    "heavens_gate_tnt": ("#f0f9ff", "#e0f2fe", "#0c4a6e", "#7dd3fc", "#0c4a6e"),
    "hells_gate_tnt": ("#7f1d1d", "#fde047", "#450a0a", "#ef4444", "#450a0a"),
    "hexahedron_tnt": ("#1e1b4b", "#c4b5fd", "#1e1b4b", "#8b5cf6", "#1e1b4b"),
    "hungry_tnt": ("#1c1917", "#a855f7", "#000000", "#d8b4fe", "#000000"),
    "hyperion_tnt": ("#4c1d95", "#fef9c3", "#2e1065", "#fcd34d", "#2e1065"),
    "ice_age_tnt": ("#0284c7", "#e0f2fe", "#0c4a6e", "#bae6fd", "#0c4a6e"),
    "icy_tnt": ("#0ea5e9", "#e0f2fe", "#075985", "#38bdf8", "#075985"),
    "knockback_tnt": ("#94a3b8", "#f8fafc", "#334155", "#e2e8f0", "#334155"),
    "leaping_tnt": ("#6d28d9", "#f5f3ff", "#2e1065", "#a78bfa", "#2e1065"),
    "levitating_tnt": ("#3b0764", "#e9d5ff", "#1e1b4b", "#c084fc", "#1e1b4b"),
    "lightning_storm_tnt": ("#1e3a8a", "#dbeafe", "#172554", "#60a5fa", "#172554"),
    "lucky_god_tnt": ("#be185d", "#fdf4ff", "#500724", "#f0abfc", "#500724"),
    "mankind_tnt": ("#1c1917", "#ef4444", "#0a0a0a", "#dc2626", "#0a0a0a"),
    "midas_tnt": ("#a16207", "#fef9c3", "#422006", "#fde047", "#422006"),
    "mineral_tnt": ("#0e7490", "#cffafe", "#164e63", "#22d3ee", "#164e63"),
    "mountaintop_tnt": ("#78350f", "#fef3c7", "#451a03", "#d97706", "#451a03"),
    "particle_tnt": ("#3b0764", "#e9d5ff", "#1e1b4b", "#a855f7", "#1e1b4b"),
    "plantation_tnt": ("#16a34a", "#dcfce7", "#14532d", "#22c55e", "#14532d"),
    "pompeii_tnt": ("#78350f", "#fef3c7", "#1c1917", "#fde047", "#1c1917"),
    "poseidon_tnt": ("#075985", "#bae6fd", "#082f49", "#38bdf8", "#082f49"),
    "present_tnt": ("#dc2626", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "pulsar_tnt": ("#1e1b4b", "#fde047", "#0c0a2a", "#facc15", "#0c0a2a"),
    "reset_tnt": ("#e7e5e4", "#ffffff", "#57534e", "#d6d3d1", "#57534e"),
    "reversed_tnt": ("#6d28d9", "#f5f3ff", "#2e1065", "#a78bfa", "#2e1065"),
    "roulette_tnt": ("#b91c1c", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "sinkhole_tnt": ("#44403c", "#e7e5e4", "#1c1917", "#78716c", "#1c1917"),
    "snowstorm_tnt": ("#e0f2fe", "#ffffff", "#bae6fd", "#f0f9ff", "#bae6fd"),
    "squaring_tnt": ("#475569", "#f8fafc", "#1e293b", "#94a3b8", "#1e293b"),
    "tetrahedron_tnt": ("#7c3aed", "#ede9fe", "#4c1d95", "#a78bfa", "#4c1d95"),
    "revolution_tnt": ("#dc2626", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "tnt_x2000": ("#7f1d1d", "#fef9c3", "#450a0a", "#ef4444", "#450a0a"),
    "toxic_clouds_tnt": ("#15803d", "#dcfce7", "#064e3b", "#4ade80", "#064e3b"),
    "tsar_bomba_tnt": ("#1c1917", "#ef4444", "#000000", "#dc2626", "#000000"),
    "unbreakable_tnt": ("#1c1917", "#a8a29e", "#0a0a0a", "#78716c", "#0a0a0a"),
    "vicious_tnt": ("#9a3412", "#fef3c7", "#450a0a", "#f97316", "#450a0a"),
    "wither_storm_tnt": ("#1c1917", "#a855f7", "#0a0a0a", "#c084fc", "#0a0a0a"),
    "world_wools_tnt": ("#f472b6", "#ffffff", "#be185d", "#fda4af", "#be185d"),
    "aether_tnt": ("#f0f9ff", "#e0f2fe", "#0c4a6e", "#38bdf8", "#0c4a6e"),
    "asteroid_tnt": ("#1c1917", "#a8a29e", "#0a0a0a", "#78716c", "#0a0a0a"),
    "atlantis_tnt": ("#075985", "#bae6fd", "#082f49", "#0ea5e9", "#082f49"),
    "city_firework_tnt": ("#831843", "#fce7f3", "#4c0519", "#f472b6", "#4c0519"),
    "compressed_tnt": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "death_ray_tnt": ("#7f1d1d", "#fef9c3", "#450a0a", "#ef4444", "#450a0a"),
    "disintegrating_tnt": ("#1c1917", "#a8a29e", "#0a0a0a", "#d6d3d1", "#0a0a0a"),
    "doomsday_tnt": ("#7f1d1d", "#fef3c7", "#450a0a", "#dc2626", "#450a0a"),
    "evil_tnt": ("#7f1d1d", "#fde047", "#450a0a", "#ef4444", "#450a0a"),
    "extinction_tnt": ("#1c1917", "#ef4444", "#000000", "#dc2626", "#000000"),
    "fiery_hell_tnt": ("#9a3412", "#fde047", "#450a0a", "#f97316", "#450a0a"),
    "flak_tnt": ("#44403c", "#fde047", "#1c1917", "#facc15", "#1c1917"),
    "flat_earth_tnt": ("#78350f", "#fef3c7", "#451a03", "#d97706", "#451a03"),
    "fluorine_tnt": ("#65a30d", "#d9f99d", "#365314", "#a3e635", "#365314"),
    "flying_tnt": ("#94a3b8", "#f8fafc", "#334155", "#e2e8f0", "#334155"),
    "grande_finale_tnt": ("#be185d", "#fdf4ff", "#500724", "#f0abfc", "#500724"),
    "heat_wave_tnt": ("#9a3412", "#fef08a", "#450a0a", "#fbbf24", "#450a0a"),
    "helix_tnt": ("#4c1d95", "#fef9c3", "#2e1065", "#a855f7", "#2e1065"),
    "hydrogen_bomb_tnt": ("#1c1917", "#fef3c7", "#000000", "#fde047", "#000000"),
    "illuminati_tnt": ("#1e1b4b", "#fde047", "#0c0a2a", "#facc15", "#0c0a2a"),
    "jumping_tnt": ("#6d28d9", "#f5f3ff", "#2e1065", "#a78bfa", "#2e1065"),
    "kola_borehole_tnt": ("#44403c", "#e7e5e4", "#1c1917", "#78716c", "#1c1917"),
    "lucky_doomsday_tnt": ("#be185d", "#fef3c7", "#500724", "#f0abfc", "#500724"),
    "meteor_storm_tnt": ("#1c1917", "#f97316", "#0a0a0a", "#ef4444", "#0a0a0a"),
    "nether_tnt": ("#7f1d1d", "#fde047", "#450a0a", "#ef4444", "#450a0a"),
    "phobos_tnt": ("#1c1917", "#f97316", "#0a0a0a", "#fb923c", "#0a0a0a"),
    "solar_eruption_tnt": ("#9a3412", "#fef9c3", "#450a0a", "#fde047", "#450a0a"),
    "stone_cold_tnt": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "structure_tnt": ("#7c4a03", "#fef3c7", "#451a03", "#d97706", "#451a03"),
    "tnt_rain_tnt": ("#1e3a8a", "#dbeafe", "#172554", "#60a5fa", "#172554"),
    "tnt_x10000": ("#7f1d1d", "#fef9c3", "#450a0a", "#ef4444", "#450a0a"),
    "vredefort_tnt": ("#78350f", "#fef3c7", "#1c1917", "#fde047", "#1c1917"),
    "wasteland_tnt": ("#78350f", "#fef3c7", "#451a03", "#a16207", "#451a03"),
    "winter_tnt": ("#e0f2fe", "#ffffff", "#bae6fd", "#f0f9ff", "#bae6fd"),
    "dynamite": ("#dc2626", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "accelerating_dynamite": ("#ef4444", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "animal_dynamite": ("#92400e", "#fef3c7", "#451a03", "#d97706", "#451a03"),
    "arrow_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "big_dynamite": ("#b91c1c", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "bouncing_dynamite": ("#6d28d9", "#f5f3ff", "#2e1065", "#a78bfa", "#2e1065"),
    "chemical_dynamite": ("#65a30d", "#d9f99d", "#365314", "#84cc16", "#365314"),
    "christmas_dynamite": ("#dc2626", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "cluster_dynamite": ("#b91c1c", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "compact_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "cubic_dynamite": ("#1e1b4b", "#c4b5fd", "#1e1b4b", "#8b5cf6", "#1e1b4b"),
    "digging_dynamite": ("#78350f", "#fef3c7", "#451a03", "#d97706", "#451a03"),
    "dripstone_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#78716c", "#1c1917"),
    "dynamite_firework": ("#831843", "#fce7f3", "#4c0519", "#f472b6", "#4c0519"),
    "dynamite_x5": ("#dc2626", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "dynamite_x20": ("#b91c1c", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "dynamite_x100": ("#7f1d1d", "#fef9c3", "#450a0a", "#ef4444", "#450a0a"),
    "dynamite_x500": ("#1c1917", "#ef4444", "#000000", "#dc2626", "#000000"),
    "end_dynamite": ("#4c1d95", "#f5f3ff", "#2e1065", "#d8b4fe", "#2e1065"),
    "ender_dynamite": ("#3b0764", "#e9d5ff", "#1e1b4b", "#c084fc", "#1e1b4b"),
    "erupting_dynamite": ("#9a3412", "#fde047", "#450a0a", "#f97316", "#450a0a"),
    "farming_dynamite": ("#16a34a", "#dcfce7", "#14532d", "#4ade80", "#14532d"),
    "fire_dynamite": ("#9a3412", "#fde047", "#450a0a", "#f97316", "#450a0a"),
    "flat_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#78716c", "#1c1917"),
    "floating_dynamite": ("#0369a1", "#bae6fd", "#082f49", "#38bdf8", "#082f49"),
    "floating_island_dynamite": ("#16a34a", "#dcfce7", "#14532d", "#4ade80", "#14532d"),
    "freeze_dynamite": ("#0ea5e9", "#e0f2fe", "#075985", "#38bdf8", "#075985"),
    "gravity_dynamite": ("#3b0764", "#e9d5ff", "#1e1b4b", "#c084fc", "#1e1b4b"),
    "grove_dynamite": ("#16a34a", "#dcfce7", "#14532d", "#22c55e", "#14532d"),
    "hellfire_dynamite": ("#7f1d1d", "#fde047", "#450a0a", "#ef4444", "#450a0a"),
    "homing_dynamite": ("#3b0764", "#e9d5ff", "#1e1b4b", "#c084fc", "#1e1b4b"),
    "honey_dynamite": ("#b45309", "#fef3c7", "#78350f", "#fbbf24", "#78350f"),
    "ice_meteor_dynamite": ("#0284c7", "#e0f2fe", "#0c4a6e", "#bae6fd", "#0c4a6e"),
    "igniter_dynamite": ("#dc2626", "#fde047", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "lava_ocean_dynamite": ("#c2410c", "#fef3c7", "#431407", "#fde047", "#431407"),
    "lightning_dynamite": ("#1e3a8a", "#dbeafe", "#172554", "#60a5fa", "#172554"),
    "lucky_dynamite": ("#be185d", "#fdf4ff", "#500724", "#f0abfc", "#500724"),
    "lush_dynamite": ("#16a34a", "#dcfce7", "#14532d", "#86efac", "#14532d"),
    "meteor_dynamite": ("#1c1917", "#f97316", "#0a0a0a", "#fb923c", "#0a0a0a"),
    "miningflat_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "multiplying_dynamite": ("#b91c1c", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "nether_grove_dynamite": ("#7f1d1d", "#fde047", "#450a0a", "#ef4444", "#450a0a"),
    "nuclear_dynamite": ("#292524", "#facc15", "#0a0a0a", "#86efac", "#0a0a0a"),
    "nuclear_waste_dynamite": ("#14532d", "#dcfce7", "#052e16", "#84cc16", "#052e16"),
    "ocean_dynamite": ("#075985", "#bae6fd", "#082f49", "#38bdf8", "#082f49"),
    "physics_dynamite": ("#3b0764", "#e9d5ff", "#1e1b4b", "#a855f7", "#1e1b4b"),
    "picky_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "prism_dynamite": ("#1e3a8a", "#dbeafe", "#172554", "#60a5fa", "#172554"),
    "pulse_dynamite": ("#1e1b4b", "#fde047", "#0c0a2a", "#facc15", "#0c0a2a"),
    "rainbow_dynamite": ("#db2777", "#ffffff", "#4c0519", "#f472b6", "#4c0519"),
    "random_dynamite": ("#be185d", "#fdf4ff", "#500724", "#f0abfc", "#500724"),
    "reaction_dynamite": ("#dc2626", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "ring_dynamite": ("#6d28d9", "#f5f3ff", "#2e1065", "#a78bfa", "#2e1065"),
    "roulette_dynamite": ("#b91c1c", "#fef3c7", "#7f1d1d", "#fca5a1", "#7f1d1d"),
    "sculk_dynamite": ("#042f2e", "#ccfbf1", "#0f172a", "#5eead4", "#0f172a"),
    "sensor_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "shatterproof_dynamite": ("#e7e5e4", "#ffffff", "#57534e", "#d6d3d1", "#57534e"),
    "snow_dynamite": ("#e0f2fe", "#ffffff", "#bae6fd", "#f0f9ff", "#bae6fd"),
    "sphere_dynamite": ("#4c1d95", "#ede9fe", "#2e1065", "#a78bfa", "#2e1065"),
    "spiral_dynamite": ("#7c3aed", "#ede9fe", "#4c1d95", "#a78bfa", "#4c1d95"),
    "timer_dynamite": ("#78350f", "#fef3c7", "#292524", "#f59e0b", "#292524"),
    "tunneling_dynamite": ("#44403c", "#e7e5e4", "#1c1917", "#a8a29e", "#1c1917"),
    "ultralight_dynamite": ("#e2e8f0", "#ffffff", "#64748b", "#f1f5f9", "#64748b"),
    "vaporize_dynamite": ("#1c1917", "#ef4444", "#0a0a0a", "#dc2626", "#0a0a0a"),
    "withering_dynamite": ("#1c1917", "#a855f7", "#0a0a0a", "#c084fc", "#0a0a0a"),
    "wool_dynamite": ("#f472b6", "#ffffff", "#be185d", "#fda4af", "#be185d"),
    "xray_dynamite": ("#1e3a8a", "#dbeafe", "#172554", "#60a5fa", "#172554"),
}
...
LANG_ES = {
    ...
    "block.tnts.acidic_tnt": "TNT Ácida",
    "block.tnts.animal_tnt": "TNT Animal",
    "block.tnts.cannon_tnt": "TNT Cañón",
    "block.tnts.catalyst_tnt": "TNT Catalizador",
    "block.tnts.chicxulub_tnt": "TNT Chicxulub",
    "block.tnts.continental_tnt": "TNT Continental",
    "block.tnts.custom_tnt": "TNT Personalizada",
    "block.tnts.deimos_tnt": "TNT Deimos",
    "block.tnts.dense_tnt": "TNT Densa",
    "block.tnts.dust_bowl_tnt": "TNT Polvo",
    "block.tnts.end_gate_tnt": "TNT Portal End",
    "block.tnts.firestorm_tnt": "TNT Tormenta de Fuego",
    "block.tnts.flower_tnt": "TNT Floresta",
    "block.tnts.ghost_tnt": "TNT Fantasma",
    "block.tnts.giant_tnt": "TNT Gigante",
    "block.tnts.global_tnt": "TNT Global",
    "block.tnts.gotthard_tnt": "TNT Gotthard",
    "block.tnts.heat_death_tnt": "TNT Muerte Térmica",
    "block.tnts.heavens_gate_tnt": "TNT Puerta del Cielo",
    "block.tnts.hells_gate_tnt": "TNT Puerta del Infierno",
    "block.tnts.hexahedron_tnt": "TNT Hexaedro",
    "block.tnts.hungry_tnt": "TNT Hambrienta",
    "block.tnts.hyperion_tnt": "TNT Hyperion",
    "block.tnts.ice_age_tnt": "TNT Edad de Hielo",
    "block.tnts.icy_tnt": "TNT Helada",
    "block.tnts.knockback_tnt": "TNT Empujón",
    "block.tnts.leaping_tnt": "TNT Saltarina Plus",
    "block.tnts.levitating_tnt": "TNT Levitación",
    "block.tnts.lightning_storm_tnt": "TNT Tormenta de Rayos",
    "block.tnts.lucky_god_tnt": "TNT Dios de la Suerte",
    "block.tnts.mankind_tnt": "TNT Humanidad",
    "block.tnts.midas_tnt": "TNT Midas",
    "block.tnts.mineral_tnt": "TNT Mineral",
    "block.tnts.mountaintop_tnt": "TNT Montaña",
    "block.tnts.particle_tnt": "TNT Partículas",
    "block.tnts.plantation_tnt": "TNT Plantación",
    "block.tnts.pompeii_tnt": "TNT Pompeya",
    "block.tnts.poseidon_tnt": "TNT Poseidón",
    "block.tnts.present_tnt": "TNT Regalo",
    "block.tnts.pulsar_tnt": "TNT Pulsar",
    "block.tnts.reset_tnt": "TNT Reset",
    "block.tnts.reversed_tnt": "TNT Inversa",
    "block.tnts.roulette_tnt": "TNT Ruleta",
    "block.tnts.sinkhole_tnt": "TNT Sumidero",
    "block.tnts.snowstorm_tnt": "TNT Tormenta de Nieve",
    "block.tnts.squaring_tnt": "TNT Cuadrada",
    "block.tnts.tetrahedron_tnt": "TNT Tetraedro",
    "block.tnts.revolution_tnt": "TNT Revolución",
    "block.tnts.tnt_x2000": "TNT x2000",
    "block.tnts.toxic_clouds_tnt": "TNT Nubes Tóxicas",
    "block.tnts.tsar_bomba_tnt": "TNT Tsar Bomba",
    "block.tnts.unbreakable_tnt": "TNT Irrompible",
    "block.tnts.vicious_tnt": "TNT Viciosa",
    "block.tnts.wither_storm_tnt": "TNT Tormenta Wither",
    "block.tnts.world_wools_tnt": "TNT Mundial de Lanas",
    "block.tnts.aether_tnt": "TNT Éter",
    "block.tnts.asteroid_tnt": "TNT Cinturón de Asteroides",
    "block.tnts.atlantis_tnt": "TNT Atlántida",
    "block.tnts.city_firework_tnt": "TNT Fuegos Ciudad",
    "block.tnts.compressed_tnt": "TNT Comprimida",
    "block.tnts.death_ray_tnt": "TNT Rayo de la Muerte",
    "block.tnts.disintegrating_tnt": "TNT Desintegradora",
    "block.tnts.doomsday_tnt": "TNT Juicio Final",
    "block.tnts.evil_tnt": "TNT Maligna",
    "block.tnts.extinction_tnt": "TNT Extinción",
    "block.tnts.fiery_hell_tnt": "TNT Infierno Ígneo",
    "block.tnts.flak_tnt": "TNT Flak",
    "block.tnts.flat_earth_tnt": "TNT Tierra Plana",
    "block.tnts.fluorine_tnt": "TNT Flúor",
    "block.tnts.flying_tnt": "TNT Voladora",
    "block.tnts.grande_finale_tnt": "TNT Gran Final",
    "block.tnts.heat_wave_tnt": "TNT Ola de Calor",
    "block.tnts.helix_tnt": "TNT Hélix",
    "block.tnts.hydrogen_bomb_tnt": "TNT Bomba de Hidrógeno",
    "block.tnts.illuminati_tnt": "TNT Illuminati",
    "block.tnts.jumping_tnt": "TNT Saltarina Mega",
    "block.tnts.kola_borehole_tnt": "TNT Pozo Kola",
    "block.tnts.lucky_doomsday_tnt": "TNT Juicio con Suerte",
    "block.tnts.meteor_storm_tnt": "TNT Tormenta de Meteoritos",
    "block.tnts.nether_tnt": "TNT Nether",
    "block.tnts.phobos_tnt": "TNT Fobos",
    "block.tnts.solar_eruption_tnt": "TNT Erupción Solar",
    "block.tnts.stone_cold_tnt": "TNT Piedra Fría",
    "block.tnts.structure_tnt": "TNT Estructura",
    "block.tnts.tnt_rain_tnt": "TNT Lluvia de TNT",
    "block.tnts.tnt_x10000": "TNT x10000",
    "block.tnts.vredefort_tnt": "TNT Vredefort",
    "block.tnts.wasteland_tnt": "TNT Páramo",
    "block.tnts.winter_tnt": "TNT Invierno",
    "block.tnts.dynamite": "Dinamita",
    "block.tnts.accelerating_dynamite": "Dinamita Acelerante",
    "block.tnts.animal_dynamite": "Dinamita Animal",
    "block.tnts.arrow_dynamite": "Dinamita de Flecha",
    "block.tnts.big_dynamite": "Dinamita Grande",
    "block.tnts.bouncing_dynamite": "Dinamita Rebote",
    "block.tnts.chemical_dynamite": "Dinamita Química",
    "block.tnts.christmas_dynamite": "Dinamita Navideña",
    "block.tnts.cluster_dynamite": "Dinamita Racimo",
    "block.tnts.compact_dynamite": "Dinamita Compacta",
    "block.tnts.cubic_dynamite": "Dinamita Cúbica",
    "block.tnts.digging_dynamite": "Dinamita de Excavación",
    "block.tnts.dripstone_dynamite": "Dinamita Dripstone",
    "block.tnts.dynamite_firework": "Dinamita Fuego Artificial",
    "block.tnts.dynamite_x5": "Dinamita x5",
    "block.tnts.dynamite_x20": "Dinamita x20",
    "block.tnts.dynamite_x100": "Dinamita x100",
    "block.tnts.dynamite_x500": "Dinamita x500",
    "block.tnts.end_dynamite": "Dinamita del End",
    "block.tnts.ender_dynamite": "Dinamita Ender",
    "block.tnts.erupting_dynamite": "Dinamita Eruptiva",
    "block.tnts.farming_dynamite": "Dinamita Agrícola",
    "block.tnts.fire_dynamite": "Dinamita de Fuego",
    "block.tnts.flat_dynamite": "Dinamita Plana",
    "block.tnts.floating_dynamite": "Dinamita Flotante",
    "block.tnts.floating_island_dynamite": "Dinamita Isla Flotante",
    "block.tnts.freeze_dynamite": "Dinamita Congelante",
    "block.tnts.gravity_dynamite": "Dinamita Gravitatoria",
    "block.tnts.grove_dynamite": "Dinamita Bosque",
    "block.tnts.hellfire_dynamite": "Dinamita Infernal",
    "block.tnts.homing_dynamite": "Dinamita Teledirigida",
    "block.tnts.honey_dynamite": "Dinamita de Miel",
    "block.tnts.ice_meteor_dynamite": "Dinamita Meteoro de Hielo",
    "block.tnts.igniter_dynamite": "Dinamita Encendedora",
    "block.tnts.lava_ocean_dynamite": "Dinamita Océano de Lava",
    "block.tnts.lightning_dynamite": "Dinamita de Rayos",
    "block.tnts.lucky_dynamite": "Dinamita de la Suerte",
    "block.tnts.lush_dynamite": "Dinamita Exuberante",
    "block.tnts.meteor_dynamite": "Dinamita Meteoro",
    "block.tnts.miningflat_dynamite": "Dinamita Minera Plana",
    "block.tnts.multiplying_dynamite": "Dinamita Multiplicante",
    "block.tnts.nether_grove_dynamite": "Dinamita Bosque Nether",
    "block.tnts.nuclear_dynamite": "Dinamita Nuclear",
    "block.tnts.nuclear_waste_dynamite": "Dinamita Residuo Nuclear",
    "block.tnts.ocean_dynamite": "Dinamita Oceánica",
    "block.tnts.physics_dynamite": "Dinamita de Física",
    "block.tnts.picky_dynamite": "Dinamita Selectiva",
    "block.tnts.prism_dynamite": "Dinamita Prisma",
    "block.tnts.pulse_dynamite": "Dinamita Pulso",
    "block.tnts.rainbow_dynamite": "Dinamita Arcoíris",
    "block.tnts.random_dynamite": "Dinamita Aleatoria",
    "block.tnts.reaction_dynamite": "Dinamita en Reacción",
    "block.tnts.ring_dynamite": "Dinamita Anillo",
    "block.tnts.roulette_dynamite": "Dinamita Ruleta",
    "block.tnts.sculk_dynamite": "Dinamita Sculk",
    "block.tnts.sensor_dynamite": "Dinamita Sensor",
    "block.tnts.shatterproof_dynamite": "Dinamita Irrompible",
    "block.tnts.snow_dynamite": "Dinamita de Nieve",
    "block.tnts.sphere_dynamite": "Dinamita Esférica",
    "block.tnts.spiral_dynamite": "Dinamita Espiral",
    "block.tnts.timer_dynamite": "Dinamita Temporizador",
    "block.tnts.tunneling_dynamite": "Dinamita Tuneladora",
    "block.tnts.ultralight_dynamite": "Dinamita Ultraligera",
    "block.tnts.vaporize_dynamite": "Dinamita Vaporizadora",
    "block.tnts.withering_dynamite": "Dinamita Wither",
    "block.tnts.wool_dynamite": "Dinamita de Lana",
    "block.tnts.xray_dynamite": "Dinamita Rayos X",
}
...
LANG_EN = {
    ...
    "block.tnts.acidic_tnt": "Acidic TNT",
    "block.tnts.animal_tnt": "Animal Kingdom",
    "block.tnts.cannon_tnt": "Cannon TNT",
    "block.tnts.catalyst_tnt": "Catalyst TNT",
    "block.tnts.chicxulub_tnt": "Chicxulub",
    "block.tnts.continental_tnt": "Continental Drift",
    "block.tnts.custom_tnt": "Custom TNT",
    "block.tnts.deimos_tnt": "Deimos",
    "block.tnts.dense_tnt": "Dense TNT",
    "block.tnts.dust_bowl_tnt": "Dust Bowl",
    "block.tnts.end_gate_tnt": "End Gate",
    "block.tnts.firestorm_tnt": "Firestorm TNT",
    "block.tnts.flower_tnt": "Flower Forest TNT",
    "block.tnts.ghost_tnt": "Ghost TNT",
    "block.tnts.giant_tnt": "Giant TNT",
    "block.tnts.global_tnt": "Global Disaster",
    "block.tnts.gotthard_tnt": "Gotthard Tunnel",
    "block.tnts.heat_death_tnt": "Heat Death",
    "block.tnts.heavens_gate_tnt": "Heavens Gate",
    "block.tnts.hells_gate_tnt": "Hells Gate",
    "block.tnts.hexahedron_tnt": "Hexahedron",
    "block.tnts.hungry_tnt": "Hungry TNT",
    "block.tnts.hyperion_tnt": "Hyperion",
    "block.tnts.ice_age_tnt": "Ice Age",
    "block.tnts.icy_tnt": "Icy TNT",
    "block.tnts.knockback_tnt": "Knockback TNT",
    "block.tnts.leaping_tnt": "Leaping TNT",
    "block.tnts.levitating_tnt": "Levitating TNT",
    "block.tnts.lightning_storm_tnt": "Lightning Storm",
    "block.tnts.lucky_god_tnt": "Lucky God",
    "block.tnts.mankind_tnt": "Mankind's Mark",
    "block.tnts.midas_tnt": "Midas TNT",
    "block.tnts.mineral_tnt": "Mineral TNT",
    "block.tnts.mountaintop_tnt": "Mountaintop Removal",
    "block.tnts.particle_tnt": "Particle Physics TNT",
    "block.tnts.plantation_tnt": "Plantation TNT",
    "block.tnts.pompeii_tnt": "Pompeii",
    "block.tnts.poseidon_tnt": "Poseidon's Wave",
    "block.tnts.present_tnt": "Present Drop",
    "block.tnts.pulsar_tnt": "Pulsar TNT",
    "block.tnts.reset_tnt": "Reset TNT",
    "block.tnts.reversed_tnt": "Reversed TNT",
    "block.tnts.roulette_tnt": "Russian Roulette",
    "block.tnts.sinkhole_tnt": "Sinkhole TNT",
    "block.tnts.snowstorm_tnt": "Snowstorm TNT",
    "block.tnts.squaring_tnt": "Squaring TNT",
    "block.tnts.tetrahedron_tnt": "Tetrahedron TNT",
    "block.tnts.revolution_tnt": "The Revolution",
    "block.tnts.tnt_x2000": "TNT x2000",
    "block.tnts.toxic_clouds_tnt": "Toxic Clouds",
    "block.tnts.tsar_bomba_tnt": "Tsar Bomba",
    "block.tnts.unbreakable_tnt": "Unbreakable TNT",
    "block.tnts.vicious_tnt": "Vicious TNT",
    "block.tnts.wither_storm_tnt": "Wither Storm",
    "block.tnts.world_wools_tnt": "World of Wools",
    "block.tnts.aether_tnt": "Aether TNT",
    "block.tnts.asteroid_tnt": "Asteroid Belt",
    "block.tnts.atlantis_tnt": "Atlantis",
    "block.tnts.city_firework_tnt": "City Firework",
    "block.tnts.compressed_tnt": "Compressed TNT",
    "block.tnts.death_ray_tnt": "Death Ray",
    "block.tnts.disintegrating_tnt": "Disintegrating TNT",
    "block.tnts.doomsday_tnt": "Doomsday",
    "block.tnts.evil_tnt": "Evil TNT",
    "block.tnts.extinction_tnt": "Extinction",
    "block.tnts.fiery_hell_tnt": "Fiery Hell",
    "block.tnts.flak_tnt": "Flak TNT",
    "block.tnts.flat_earth_tnt": "Flat Earth",
    "block.tnts.fluorine_tnt": "Fluorine TNT",
    "block.tnts.flying_tnt": "Flying TNT",
    "block.tnts.grande_finale_tnt": "Grande Finale",
    "block.tnts.heat_wave_tnt": "Heat Wave",
    "block.tnts.helix_tnt": "Helix TNT",
    "block.tnts.hydrogen_bomb_tnt": "Hydrogen Bomb",
    "block.tnts.illuminati_tnt": "Illuminati TNT",
    "block.tnts.jumping_tnt": "Jumping TNT",
    "block.tnts.kola_borehole_tnt": "Kola Borehole",
    "block.tnts.lucky_doomsday_tnt": "Lucky Doomsday",
    "block.tnts.meteor_storm_tnt": "Meteor Storm",
    "block.tnts.nether_tnt": "Nether TNT",
    "block.tnts.phobos_tnt": "Phobos",
    "block.tnts.solar_eruption_tnt": "Solar Eruption",
    "block.tnts.stone_cold_tnt": "Stone Cold",
    "block.tnts.structure_tnt": "Structure TNT",
    "block.tnts.tnt_rain_tnt": "TNT Rain",
    "block.tnts.tnt_x10000": "TNTx10000",
    "block.tnts.vredefort_tnt": "Vredefort",
    "block.tnts.wasteland_tnt": "Wasteland TNT",
    "block.tnts.winter_tnt": "Winter TNT",
    "block.tnts.dynamite": "Dynamite",
    "block.tnts.accelerating_dynamite": "Accelerating Dynamite",
    "block.tnts.animal_dynamite": "Animal Dynamite",
    "block.tnts.arrow_dynamite": "Arrow Dynamite",
    "block.tnts.big_dynamite": "Big Dynamite",
    "block.tnts.bouncing_dynamite": "Bouncing Dynamite",
    "block.tnts.chemical_dynamite": "Chemical Dynamite",
    "block.tnts.christmas_dynamite": "Christmas Dynamite",
    "block.tnts.cluster_dynamite": "Cluster Dynamite",
    "block.tnts.compact_dynamite": "Compact Dynamite",
    "block.tnts.cubic_dynamite": "Cubic Dynamite",
    "block.tnts.digging_dynamite": "Digging Dynamite",
    "block.tnts.dripstone_dynamite": "Dripstone Dynamite",
    "block.tnts.dynamite_firework": "Dynamite Firework",
    "block.tnts.dynamite_x5": "Dynamite x5",
    "block.tnts.dynamite_x20": "Dynamite x20",
    "block.tnts.dynamite_x100": "Dynamite x100",
    "block.tnts.dynamite_x500": "Dynamite x500",
    "block.tnts.end_dynamite": "End Dynamite",
    "block.tnts.ender_dynamite": "Ender Dynamite",
    "block.tnts.erupting_dynamite": "Erupting Dynamite",
    "block.tnts.farming_dynamite": "Farming Dynamite",
    "block.tnts.fire_dynamite": "Fire Dynamite",
    "block.tnts.flat_dynamite": "Flat Dynamite",
    "block.tnts.floating_dynamite": "Floating Dynamite",
    "block.tnts.floating_island_dynamite": "Floating Island Dynamite",
    "block.tnts.freeze_dynamite": "Freeze Dynamite",
    "block.tnts.gravity_dynamite": "Gravity Dynamite",
    "block.tnts.grove_dynamite": "Grove Dynamite",
    "block.tnts.hellfire_dynamite": "Hellfire Dynamite",
    "block.tnts.homing_dynamite": "Homing Dynamite",
    "block.tnts.honey_dynamite": "Honey Dynamite",
    "block.tnts.ice_meteor_dynamite": "Ice Meteor Dynamite",
    "block.tnts.igniter_dynamite": "Igniter Dynamite",
    "block.tnts.lava_ocean_dynamite": "Lava Ocean Dynamite",
    "block.tnts.lightning_dynamite": "Lightning Dynamite",
    "block.tnts.lucky_dynamite": "Lucky Dynamite",
    "block.tnts.lush_dynamite": "Lush Dynamite",
    "block.tnts.meteor_dynamite": "Meteor Dynamite",
    "block.tnts.miningflat_dynamite": "Miningflat Dynamite",
    "block.tnts.multiplying_dynamite": "Multiplying Dynamite",
    "block.tnts.nether_grove_dynamite": "Nether Grove Dynamite",
    "block.tnts.nuclear_dynamite": "Nuclear Dynamite",
    "block.tnts.nuclear_waste_dynamite": "Nuclear Waste Dynamite",
    "block.tnts.ocean_dynamite": "Ocean Dynamite",
    "block.tnts.physics_dynamite": "Physics Dynamite",
    "block.tnts.picky_dynamite": "Picky Dynamite",
    "block.tnts.prism_dynamite": "Prism Dynamite",
    "block.tnts.pulse_dynamite": "Pulse Dynamite",
    "block.tnts.rainbow_dynamite": "Rainbow Dynamite",
    "block.tnts.random_dynamite": "Random Dynamite",
    "block.tnts.reaction_dynamite": "Reaction Dynamite",
    "block.tnts.ring_dynamite": "Ring Dynamite",
    "block.tnts.roulette_dynamite": "Roulette Dynamite",
    "block.tnts.sculk_dynamite": "Sculk Dynamite",
    "block.tnts.sensor_dynamite": "Sensor Dynamite",
    "block.tnts.shatterproof_dynamite": "Shatterproof Dynamite",
    "block.tnts.snow_dynamite": "Snow Dynamite",
    "block.tnts.sphere_dynamite": "Sphere Dynamite",
    "block.tnts.spiral_dynamite": "Spiral Dynamite",
    "block.tnts.timer_dynamite": "Timer Dynamite",
    "block.tnts.tunneling_dynamite": "Tunneling Dynamite",
    "block.tnts.ultralight_dynamite": "Ultralight Dynamite",
    "block.tnts.vaporize_dynamite": "Vaporize Dynamite",
    "block.tnts.withering_dynamite": "Withering Dynamite",
    "block.tnts.wool_dynamite": "Wool Dynamite",
    "block.tnts.xray_dynamite": "XRay Dynamite",
}
...
LANG_PT = {
    ...
    "block.tnts.acidic_tnt": "TNT Ácida",
    "block.tnts.animal_tnt": "TNT Animal",
    "block.tnts.cannon_tnt": "TNT Canhão",
    "block.tnts.catalyst_tnt": "TNT Catalisador",
    "block.tnts.chicxulub_tnt": "Chicxulub",
    "block.tnts.continental_tnt": "Deriva Continental",
    "block.tnts.custom_tnt": "TNT Personalizada",
    "block.tnts.deimos_tnt": "Deimos",
    "block.tnts.dense_tnt": "TNT Densa",
    "block.tnts.dust_bowl_tnt": "Tigela de Poeira",
    "block.tnts.end_gate_tnt": "Portal do End",
    "block.tnts.firestorm_tnt": "TNT Tempestade de Fogo",
    "block.tnts.flower_tnt": "TNT Floresta de Flores",
    "block.tnts.ghost_tnt": "TNT Fantasma",
    "block.tnts.giant_tnt": "TNT Gigante",
    "block.tnts.global_tnt": "Desastre Global",
    "block.tnts.gotthard_tnt": "Túnel Gotthard",
    "block.tnts.heat_death_tnt": "Morte Térmica",
    "block.tnts.heavens_gate_tnt": "Portal do Céu",
    "block.tnts.hells_gate_tnt": "Portal do Inferno",
    "block.tnts.hexahedron_tnt": "Hexaedro",
    "block.tnts.hungry_tnt": "TNT Faminta",
    "block.tnts.hyperion_tnt": "Hyperion",
    "block.tnts.ice_age_tnt": "Era do Gelo",
    "block.tnts.icy_tnt": "TNT Gelada",
    "block.tnts.knockback_tnt": "TNT Empurrão",
    "block.tnts.leaping_tnt": "TNT Saltitante",
    "block.tnts.levitating_tnt": "TNT Levitação",
    "block.tnts.lightning_storm_tnt": "Tempestade de Raios",
    "block.tnts.lucky_god_tnt": "Deus da Sorte",
    "block.tnts.mankind_tnt": "Marca da Humanidade",
    "block.tnts.midas_tnt": "TNT Midas",
    "block.tnts.mineral_tnt": "TNT Mineral",
    "block.tnts.mountaintop_tnt": "Remoção de Montanha",
    "block.tnts.particle_tnt": "TNT Física de Partículas",
    "block.tnts.plantation_tnt": "TNT Plantação",
    "block.tnts.pompeii_tnt": "Pompeia",
    "block.tnts.poseidon_tnt": "Onda de Poseidon",
    "block.tnts.present_tnt": "Presente",
    "block.tnts.pulsar_tnt": "TNT Pulsar",
    "block.tnts.reset_tnt": "TNT Reset",
    "block.tnts.reversed_tnt": "TNT Invertida",
    "block.tnts.roulette_tnt": "Roleta Russa",
    "block.tnts.sinkhole_tnt": "TNT Sumidouro",
    "block.tnts.snowstorm_tnt": "TNT Nevasca",
    "block.tnts.squaring_tnt": "TNT Quadrada",
    "block.tnts.tetrahedron_tnt": "TNT Tetraedro",
    "block.tnts.revolution_tnt": "A Revolução",
    "block.tnts.tnt_x2000": "TNT x2000",
    "block.tnts.toxic_clouds_tnt": "Nuvens Tóxicas",
    "block.tnts.tsar_bomba_tnt": "Bomba Tsar",
    "block.tnts.unbreakable_tnt": "TNT Irrompível",
    "block.tnts.vicious_tnt": "TNT Viciosa",
    "block.tnts.wither_storm_tnt": "Tempestade Wither",
    "block.tnts.world_wools_tnt": "Mundo de Lãs",
    "block.tnts.aether_tnt": "TNT Éter",
    "block.tnts.asteroid_tnt": "Cinturão de Asteroides",
    "block.tnts.atlantis_tnt": "Atlântida",
    "block.tnts.city_firework_tnt": "Fogos de Artifício",
    "block.tnts.compressed_tnt": "TNT Comprimida",
    "block.tnts.death_ray_tnt": "Raio da Morte",
    "block.tnts.disintegrating_tnt": "TNT Desintegradora",
    "block.tnts.doomsday_tnt": "Juízo Final",
    "block.tnts.evil_tnt": "TNT Maligna",
    "block.tnts.extinction_tnt": "Extinção",
    "block.tnts.fiery_hell_tnt": "Inferno Ígneo",
    "block.tnts.flak_tnt": "TNT Flak",
    "block.tnts.flat_earth_tnt": "Terra Plana",
    "block.tnts.fluorine_tnt": "TNT Flúor",
    "block.tnts.flying_tnt": "TNT Voadora",
    "block.tnts.grande_finale_tnt": "Grande Final",
    "block.tnts.heat_wave_tnt": "Onda de Calor",
    "block.tnts.helix_tnt": "TNT Hélice",
    "block.tnts.hydrogen_bomb_tnt": "Bomba de Hidrogênio",
    "block.tnts.illuminati_tnt": "TNT Illuminati",
    "block.tnts.jumping_tnt": "TNT Saltitante",
    "block.tnts.kola_borehole_tnt": "Poço Kola",
    "block.tnts.lucky_doomsday_tnt": "Juízo Sortudo",
    "block.tnts.meteor_storm_tnt": "Tempestade de Meteoritos",
    "block.tnts.nether_tnt": "TNT Nether",
    "block.tnts.phobos_tnt": "Phobos",
    "block.tnts.solar_eruption_tnt": "Erupção Solar",
    "block.tnts.stone_cold_tnt": "Pedra Fria",
    "block.tnts.structure_tnt": "TNT Estrutura",
    "block.tnts.tnt_rain_tnt": "Chuva de TNT",
    "block.tnts.tnt_x10000": "TNTx10000",
    "block.tnts.vredefort_tnt": "Vredefort",
    "block.tnts.wasteland_tnt": "TNT Ermo",
    "block.tnts.winter_tnt": "TNT Inverno",
    "block.tnts.dynamite": "Dinamite",
    "block.tnts.accelerating_dynamite": "Dinamita Acelerante",
    "block.tnts.animal_dynamite": "Dinamita Animal",
    "block.tnts.arrow_dynamite": "Dinamita de Flecha",
    "block.tnts.big_dynamite": "Dinamita Grande",
    "block.tnts.bouncing_dynamite": "Dinamita Rebote",
    "block.tnts.chemical_dynamite": "Dinamita Química",
    "block.tnts.christmas_dynamite": "Dinamita Natal",
    "block.tnts.cluster_dynamite": "Dinamita Cluster",
    "block.tnts.compact_dynamite": "Dinamita Compacta",
    "block.tnts.cubic_dynamite": "Dinamita Cúbica",
    "block.tnts.digging_dynamite": "Dinamita de Escavação",
    "block.tnts.dripstone_dynamite": "Dinamita Dripstone",
    "block.tnts.dynamite_firework": "Dinamita Fogos",
    "block.tnts.dynamite_x5": "Dinamita x5",
    "block.tnts.dynamite_x20": "Dinamita x20",
    "block.tnts.dynamite_x100": "Dinamita x100",
    "block.tnts.dynamite_x500": "Dinamita x500",
    "block.tnts.end_dynamite": "Dinamita do End",
    "block.tnts.ender_dynamite": "Dinamita Ender",
    "block.tnts.erupting_dynamite": "Dinamita Eruptiva",
    "block.tnts.farming_dynamite": "Dinamita Agrícola",
    "block.tnts.fire_dynamite": "Dinamita de Fogo",
    "block.tnts.flat_dynamite": "Dinamita Plana",
    "block.tnts.floating_dynamite": "Dinamita Flutuante",
    "block.tnts.floating_island_dynamite": "Dinamita Ilha Flutuante",
    "block.tnts.freeze_dynamite": "Dinamita Congelante",
    "block.tnts.gravity_dynamite": "Dinamita Gravitacional",
    "block.tnts.grove_dynamite": "Dinamita Bosque",
    "block.tnts.hellfire_dynamite": "Dinamita Infernal",
    "block.tnts.homing_dynamite": "Dinamita Teleguiada",
    "block.tnts.honey_dynamite": "Dinamita de Mel",
    "block.tnts.ice_meteor_dynamite": "Dinamita Meteoro de Gelo",
    "block.tnts.igniter_dynamite": "Dinamita Acendedora",
    "block.tnts.lava_ocean_dynamite": "Dinamita Oceano de Lava",
    "block.tnts.lightning_dynamite": "Dinamita de Raios",
    "block.tnts.lucky_dynamite": "Dinamita da Sorte",
    "block.tnts.lush_dynamite": "Dinamita Exuberante",
    "block.tnts.meteor_dynamite": "Dinamita Meteoro",
    "block.tnts.miningflat_dynamite": "Dinamita Mineração",
    "block.tnts.multiplying_dynamite": "Dinamita Multiplicadora",
    "block.tnts.nether_grove_dynamite": "Dinamita Bosque Nether",
    "block.tnts.nuclear_dynamite": "Dinamita Nuclear",
    "block.tnts.nuclear_waste_dynamite": "Dinamita Resíduo Nuclear",
    "block.tnts.ocean_dynamite": "Dinamita Oceânica",
    "block.tnts.physics_dynamite": "Dinamita de Física",
    "block.tnts.picky_dynamite": "Dinamita Seletiva",
    "block.tnts.prism_dynamite": "Dinamita Prisma",
    "block.tnts.pulse_dynamite": "Dinamita Pulso",
    "block.tnts.rainbow_dynamite": "Dinamita Arco-íris",
    "block.tnts.random_dynamite": "Dinamita Aleatória",
    "block.tnts.reaction_dynamite": "Dinamita em Reação",
    "block.tnts.ring_dynamite": "Dinamita Anel",
    "block.tnts.roulette_dynamite": "Dinamita Roleta",
    "block.tnts.sculk_dynamite": "Dinamita Sculk",
    "block.tnts.sensor_dynamite": "Dinamita Sensor",
    "block.tnts.shatterproof_dynamite": "Dinamita Irrompível",
    "block.tnts.snow_dynamite": "Dinamita de Neve",
    "block.tnts.sphere_dynamite": "Dinamita Esférica",
    "block.tnts.spiral_dynamite": "Dinamita Espiral",
    "block.tnts.timer_dynamite": "Dinamita Temporizador",
    "block.tnts.tunneling_dynamite": "Dinamita Tuneladora",
    "block.tnts.ultralight_dynamite": "Dinamita Ultraleve",
    "block.tnts.vaporize_dynamite": "Dinamita Vaporizadora",
    "block.tnts.withering_dynamite": "Dinamita Wither",
    "block.tnts.wool_dynamite": "Dinamita de Lã",
    "block.tnts.xray_dynamite": "Dinamita Raios X",
}
...
LANG_DE = {
    ...
    "block.tnts.acidic_tnt": "TNT Säure",
    "block.tnts.animal_tnt": "TNT Tierreich",
    "block.tnts.cannon_tnt": "TNT Kanone",
    "block.tnts.catalyst_tnt": "TNT Katalysator",
    "block.tnts.chicxulub_tnt": "Chicxulub",
    "block.tnts.continental_tnt": "Kontinentalverschiebung",
    "block.tnts.custom_tnt": "TNT Benutzerdefiniert",
    "block.tnts.deimos_tnt": "Deimos",
    "block.tnts.dense_tnt": "TNT Dicht",
    "block.tnts.dust_bowl_tnt": "Staubbecken",
    "block.tnts.end_gate_tnt": "End-Tor",
    "block.tnts.firestorm_tnt": "Feuersturm-TNT",
    "block.tnts.flower_tnt": "Blumenwald-TNT",
    "block.tnts.ghost_tnt": "Geister-TNT",
    "block.tnts.giant_tnt": "Riesen-TNT",
    "block.tnts.global_tnt": "Globale Katastrophe",
    "block.tnts.gotthard_tnt": "Gotthard-Tunnel",
    "block.tnts.heat_death_tnt": "Hitzetod",
    "block.tnts.heavens_gate_tnt": "Himmelstor",
    "block.tnts.hells_gate_tnt": "Höllentor",
    "block.tnts.hexahedron_tnt": "Hexaeder",
    "block.tnts.hungry_tnt": "Hungrige TNT",
    "block.tnts.hyperion_tnt": "Hyperion",
    "block.tnts.ice_age_tnt": "Eiszeit",
    "block.tnts.icy_tnt": "Eisige TNT",
    "block.tnts.knockback_tnt": "Rückstoß-TNT",
    "block.tnts.leaping_tnt": "Springende TNT",
    "block.tnts.levitating_tnt": "Schwebende TNT",
    "block.tnts.lightning_storm_tnt": "Gewittersturm",
    "block.tnts.lucky_god_tnt": "Glücksgott",
    "block.tnts.mankind_tnt": "Menschheitszeichen",
    "block.tnts.midas_tnt": "Midas-TNT",
    "block.tnts.mineral_tnt": "Mineral-TNT",
    "block.tnts.mountaintop_tnt": "Gipfelentfernung",
    "block.tnts.particle_tnt": "Teilchenphysik-TNT",
    "block.tnts.plantation_tnt": "Pflanzungs-TNT",
    "block.tnts.pompeii_tnt": "Pompeji",
    "block.tnts.poseidon_tnt": "Poseidons Welle",
    "block.tnts.present_tnt": "Geschenkfall",
    "block.tnts.pulsar_tnt": "Pulsar-TNT",
    "block.tnts.reset_tnt": "Reset-TNT",
    "block.tnts.reversed_tnt": "Umgekehrte TNT",
    "block.tnts.roulette_tnt": "Russisches Roulette",
    "block.tnts.sinkhole_tnt": "Erdloch-TNT",
    "block.tnts.snowstorm_tnt": "Schneesturm-TNT",
    "block.tnts.squaring_tnt": "Quadratische TNT",
    "block.tnts.tetrahedron_tnt": "Tetraeder-TNT",
    "block.tnts.revolution_tnt": "Die Revolution",
    "block.tnts.tnt_x2000": "TNT x2000",
    "block.tnts.toxic_clouds_tnt": "Toxische Wolken",
    "block.tnts.tsar_bomba_tnt": "Zarenbombe",
    "block.tnts.unbreakable_tnt": "Unzerstörbare TNT",
    "block.tnts.vicious_tnt": "Bösartige TNT",
    "block.tnts.wither_storm_tnt": "Wither-Sturm",
    "block.tnts.world_wools_tnt": "Wollwelt",
    "block.tnts.aether_tnt": "Äther-TNT",
    "block.tnts.asteroid_tnt": "Asteroidengürtel",
    "block.tnts.atlantis_tnt": "Atlantis",
    "block.tnts.city_firework_tnt": "Stadtfeuerwerk",
    "block.tnts.compressed_tnt": "Komprimierte TNT",
    "block.tnts.death_ray_tnt": "Todesstrahl",
    "block.tnts.disintegrating_tnt": "Desintegrations-TNT",
    "block.tnts.doomsday_tnt": "Weltuntergang",
    "block.tnts.evil_tnt": "Böse TNT",
    "block.tnts.extinction_tnt": "Aussterben",
    "block.tnts.fiery_hell_tnt": "Feurige Hölle",
    "block.tnts.flak_tnt": "Flak-TNT",
    "block.tnts.flat_earth_tnt": "Flache Erde",
    "block.tnts.fluorine_tnt": "Fluor-TNT",
    "block.tnts.flying_tnt": "Fliegende TNT",
    "block.tnts.grande_finale_tnt": "Großes Finale",
    "block.tnts.heat_wave_tnt": "Hitzewelle",
    "block.tnts.helix_tnt": "Helix-TNT",
    "block.tnts.hydrogen_bomb_tnt": "Wasserstoffbombe",
    "block.tnts.illuminati_tnt": "Illuminati-TNT",
    "block.tnts.jumping_tnt": "Springende TNT",
    "block.tnts.kola_borehole_tnt": "Kola-Bohrung",
    "block.tnts.lucky_doomsday_tnt": "Glücklicher Weltuntergang",
    "block.tnts.meteor_storm_tnt": "Meteorensturm",
    "block.tnts.nether_tnt": "Nether-TNT",
    "block.tnts.phobos_tnt": "Phobos",
    "block.tnts.solar_eruption_tnt": "Sonneneruption",
    "block.tnts.stone_cold_tnt": "Eisiger Stein",
    "block.tnts.structure_tnt": "Struktur-TNT",
    "block.tnts.tnt_rain_tnt": "TNT-Regen",
    "block.tnts.tnt_x10000": "TNTx10000",
    "block.tnts.vredefort_tnt": "Vredefort",
    "block.tnts.wasteland_tnt": "Ödland-TNT",
    "block.tnts.winter_tnt": "Winter-TNT",
    "block.tnts.dynamite": "Dynamit",
    "block.tnts.accelerating_dynamite": "Beschleunigende Dynamit",
    "block.tnts.animal_dynamite": "Tier-Dynamit",
    "block.tnts.arrow_dynamite": "Pfeil-Dynamit",
    "block.tnts.big_dynamite": "Große Dynamit",
    "block.tnts.bouncing_dynamite": "Hüpfende Dynamit",
    "block.tnts.chemical_dynamite": "Chemische Dynamit",
    "block.tnts.christmas_dynamite": "Weihnachts-Dynamit",
    "block.tnts.cluster_dynamite": "Cluster-Dynamit",
    "block.tnts.compact_dynamite": "Kompakte Dynamit",
    "block.tnts.cubic_dynamite": "Würfel-Dynamit",
    "block.tnts.digging_dynamite": "Bau-Dynamit",
    "block.tnts.dripstone_dynamite": "Tropfstein-Dynamit",
    "block.tnts.dynamite_firework": "Feuerwerk-Dynamit",
    "block.tnts.dynamite_x5": "Dynamit x5",
    "block.tnts.dynamite_x20": "Dynamit x20",
    "block.tnts.dynamite_x100": "Dynamit x100",
    "block.tnts.dynamite_x500": "Dynamit x500",
    "block.tnts.end_dynamite": "End-Dynamit",
    "block.tnts.ender_dynamite": "Ender-Dynamit",
    "block.tnts.erupting_dynamite": "Ausbruchs-Dynamit",
    "block.tnts.farming_dynamite": "Landwirtschafts-Dynamit",
    "block.tnts.fire_dynamite": "Feuer-Dynamit",
    "block.tnts.flat_dynamite": "Flache Dynamit",
    "block.tnts.floating_dynamite": "Schwebende Dynamit",
    "block.tnts.floating_island_dynamite": "Schwebende-Insel-Dynamit",
    "block.tnts.freeze_dynamite": "Einfrier-Dynamit",
    "block.tnts.gravity_dynamite": "Gravitations-Dynamit",
    "block.tnts.grove_dynamite": "Wald-Dynamit",
    "block.tnts.hellfire_dynamite": "Höllenfeuer-Dynamit",
    "block.tnts.homing_dynamite": "Lenk-Dynamit",
    "block.tnts.honey_dynamite": "Honig-Dynamit",
    "block.tnts.ice_meteor_dynamite": "Eis-Meteor-Dynamit",
    "block.tnts.igniter_dynamite": "Zünd-Dynamit",
    "block.tnts.lava_ocean_dynamite": "Lava-Ozean-Dynamit",
    "block.tnts.lightning_dynamite": "Blitz-Dynamit",
    "block.tnts.lucky_dynamite": "Glücks-Dynamit",
    "block.tnts.lush_dynamite": "Üppige Dynamit",
    "block.tnts.meteor_dynamite": "Meteor-Dynamit",
    "block.tnts.miningflat_dynamite": "Bergbau-Flach-Dynamit",
    "block.tnts.multiplying_dynamite": "Multiplizierende Dynamit",
    "block.tnts.nether_grove_dynamite": "Netherwald-Dynamit",
    "block.tnts.nuclear_dynamite": "Kernwaffen-Dynamit",
    "block.tnts.nuclear_waste_dynamite": "Nuklearabfall-Dynamit",
    "block.tnts.ocean_dynamite": "Ozean-Dynamit",
    "block.tnts.physics_dynamite": "Physik-Dynamit",
    "block.tnts.picky_dynamite": "Auswahl-Dynamit",
    "block.tnts.prism_dynamite": "Prisma-Dynamit",
    "block.tnts.pulse_dynamite": "Puls-Dynamit",
    "block.tnts.rainbow_dynamite": "Regenbogen-Dynamit",
    "block.tnts.random_dynamite": "Zufällige Dynamit",
    "block.tnts.reaction_dynamite": "Reaktions-Dynamit",
    "block.tnts.ring_dynamite": "Ring-Dynamit",
    "block.tnts.roulette_dynamite": "Roulette-Dynamit",
    "block.tnts.sculk_dynamite": "Sculk-Dynamit",
    "block.tnts.sensor_dynamite": "Sensor-Dynamit",
    "block.tnts.shatterproof_dynamite": "Bruchsichere Dynamit",
    "block.tnts.snow_dynamite": "Schnee-Dynamit",
    "block.tnts.sphere_dynamite": "Kugel-Dynamit",
    "block.tnts.spiral_dynamite": "Spiral-Dynamit",
    "block.tnts.timer_dynamite": "Timer-Dynamit",
    "block.tnts.tunneling_dynamite": "Tunnel-Dynamit",
    "block.tnts.ultralight_dynamite": "Ultraleicht-Dynamit",
    "block.tnts.vaporize_dynamite": "Verdampfungs-Dynamit",
    "block.tnts.withering_dynamite": "Verwilderungs-Dynamit",
    "block.tnts.wool_dynamite": "Woll-Dynamit",
    "block.tnts.xray_dynamite": "Röntgen-Dynamit",
}
...
LANG_FR = {
    ...
    "block.tnts.acidic_tnt": "TNT Acide",
    "block.tnts.animal_tnt": "Royaume Animal",
    "block.tnts.cannon_tnt": "TNT Canon",
    "block.tnts.catalyst_tnt": "TNT Catalyseur",
    "block.tnts.chicxulub_tnt": "Chicxulub",
    "block.tnts.continental_tnt": "Dérive Continentale",
    "block.tnts.custom_tnt": "TNT Personnalisée",
    "block.tnts.deimos_tnt": "Déimos",
    "block.tnts.dense_tnt": "TNT Dense",
    "block.tnts.dust_bowl_tnt": "Cuve à Poussière",
    "block.tnts.end_gate_tnt": "Portail de l'End",
    "block.tnts.firestorm_tnt": "TNT Tempête de Feu",
    "block.tnts.flower_tnt": "TNT Forêt Florale",
    "block.tnts.ghost_tnt": "TNT Fantôme",
    "block.tnts.giant_tnt": "TNT Géante",
    "block.tnts.global_tnt": "Catastrophe Mondiale",
    "block.tnts.gotthard_tnt": "Tunnel du Gotthard",
    "block.tnts.heat_death_tnt": "Mort Thermique",
    "block.tnts.heavens_gate_tnt": "Porte des Cieux",
    "block.tnts.hells_gate_tnt": "Porte des Enfers",
    "block.tnts.hexahedron_tnt": "Hexaèdre",
    "block.tnts.hungry_tnt": "TNT Affamée",
    "block.tnts.hyperion_tnt": "Hyperion",
    "block.tnts.ice_age_tnt": "Ère Glacière",
    "block.tnts.icy_tnt": "TNT Glaciale",
    "block.tnts.knockback_tnt": "TNT Poussée",
    "block.tnts.leaping_tnt": "TNT Sautillante",
    "block.tnts.levitating_tnt": "TNT Lévitante",
    "block.tnts.lightning_storm_tnt": "Tempête Électrique",
    "block.tnts.lucky_god_tnt": "Dieu de la Chance",
    "block.tnts.mankind_tnt": "Marque de l'Humanité",
    "block.tnts.midas_tnt": "TNT Midas",
    "block.tnts.mineral_tnt": "TNT Minérale",
    "block.tnts.mountaintop_tnt": "Démontage de Sommet",
    "block.tnts.particle_tnt": "TNT Physique des Particules",
    "block.tnts.plantation_tnt": "TNT Plantation",
    "block.tnts.pompeii_tnt": "Pompéi",
    "block.tnts.poseidon_tnt": "Vague de Poséidon",
    "block.tnts.present_tnt": "Cadeau Tombant",
    "block.tnts.pulsar_tnt": "TNT Pulsar",
    "block.tnts.reset_tnt": "TNT Réinitialisation",
    "block.tnts.reversed_tnt": "TNT Inversée",
    "block.tnts.roulette_tnt": "Russe Roulette",
    "block.tnts.sinkhole_tnt": "TNT Effondrement",
    "block.tnts.snowstorm_tnt": "TNT Blizzard",
    "block.tnts.squaring_tnt": "TNT Carrée",
    "block.tnts.tetrahedron_tnt": "TNT Tétraèdre",
    "block.tnts.revolution_tnt": "La Révolution",
    "block.tnts.tnt_x2000": "TNT x2000",
    "block.tnts.toxic_clouds_tnt": "Nuages Toxiques",
    "block.tnts.tsar_bomba_tnt": "Tsar Bomba",
    "block.tnts.unbreakable_tnt": "TNT Incassable",
    "block.tnts.vicious_tnt": "TNT Vicieuse",
    "block.tnts.wither_storm_tnt": "Tempête Wither",
    "block.tnts.world_wools_tnt": "Monde de Laines",
    "block.tnts.aether_tnt": "TNT Éther",
    "block.tnts.asteroid_tnt": "Ceinture d'Astéroïdes",
    "block.tnts.atlantis_tnt": "Atlantide",
    "block.tnts.city_firework_tnt": "Feu d'Artifice Urbain",
    "block.tnts.compressed_tnt": "TNT Compressée",
    "block.tnts.death_ray_tnt": "Rayon de la Mort",
    "block.tnts.disintegrating_tnt": "TNT Désintégratrice",
    "block.tnts.doomsday_tnt": "Jugement Dernier",
    "block.tnts.evil_tnt": "TNT Maléfique",
    "block.tnts.extinction_tnt": "Extinction",
    "block.tnts.fiery_hell_tnt": "Enfer de Feu",
    "block.tnts.flak_tnt": "TNT Flak",
    "block.tnts.flat_earth_tnt": "Terre Plate",
    "block.tnts.fluorine_tnt": "TNT Fluor",
    "block.tnts.flying_tnt": "TNT Volante",
    "block.tnts.grande_finale_tnt": "Grand Final",
    "block.tnts.heat_wave_tnt": "Canicule",
    "block.tnts.helix_tnt": "TNT Hélice",
    "block.tnts.hydrogen_bomb_tnt": "Bombe Hydrogène",
    "block.tnts.illuminati_tnt": "TNT Illuminati",
    "block.tnts.jumping_tnt": "TNT Bondissante",
    "block.tnts.kola_borehole_tnt": "Forage de Kola",
    "block.tnts.lucky_doomsday_tnt": "Jugement Chanceux",
    "block.tnts.meteor_storm_tnt": "Tempête de Météorites",
    "block.tnts.nether_tnt": "TNT Nether",
    "block.tnts.phobos_tnt": "Phobos",
    "block.tnts.solar_eruption_tnt": "Éruption Solaire",
    "block.tnts.stone_cold_tnt": "Pierre Glacée",
    "block.tnts.structure_tnt": "TNT Structure",
    "block.tnts.tnt_rain_tnt": "Pluie de TNT",
    "block.tnts.tnt_x10000": "TNTx10000",
    "block.tnts.vredefort_tnt": "Vredefort",
    "block.tnts.wasteland_tnt": "TNT Désolation",
    "block.tnts.winter_tnt": "TNT Hiver",
    "block.tnts.dynamite": "Dynamite",
    "block.tnts.accelerating_dynamite": "Dynamite Accélérante",
    "block.tnts.animal_dynamite": "Dynamite Animale",
    "block.tnts.arrow_dynamite": "Dynamite Flèche",
    "block.tnts.big_dynamite": "Grosse Dynamite",
    "block.tnts.bouncing_dynamite": "Dynamite Rebondissante",
    "block.tnts.chemical_dynamite": "Dynamite Chimique",
    "block.tnts.christmas_dynamite": "Dynamite de Noël",
    "block.tnts.cluster_dynamite": "Dynamite en Grappe",
    "block.tnts.compact_dynamite": "Dynamite Compacte",
    "block.tnts.cubic_dynamite": "Dynamite Cubique",
    "block.tnts.digging_dynamite": "Dynamite de Fouille",
    "block.tnts.dripstone_dynamite": "Dynamite Stalactite",
    "block.tnts.dynamite_firework": "Dynamite Feu d'Artifice",
    "block.tnts.dynamite_x5": "Dynamite x5",
    "block.tnts.dynamite_x20": "Dynamite x20",
    "block.tnts.dynamite_x100": "Dynamite x100",
    "block.tnts.dynamite_x500": "Dynamite x500",
    "block.tnts.end_dynamite": "Dynamite de l'End",
    "block.tnts.ender_dynamite": "Dynamite Ender",
    "block.tnts.erupting_dynamite": "Dynamite Éruptive",
    "block.tnts.farming_dynamite": "Dynamite Agricole",
    "block.tnts.fire_dynamite": "Dynamite de Feu",
    "block.tnts.flat_dynamite": "Dynamite Plate",
    "block.tnts.floating_dynamite": "Dynamite Flottante",
    "block.tnts.floating_island_dynamite": "Dynamite Île Flottante",
    "block.tnts.freeze_dynamite": "Dynamite Congélation",
    "block.tnts.gravity_dynamite": "Dynamite Gravitationnelle",
    "block.tnts.grove_dynamite": "Dynamite Bosquet",
    "block.tnts.hellfire_dynamite": "Dynamite Infernale",
    "block.tnts.homing_dynamite": "Dynamite Autoguidée",
    "block.tnts.honey_dynamite": "Dynamite Miel",
    "block.tnts.ice_meteor_dynamite": "Dynamite Météore Glacial",
    "block.tnts.igniter_dynamite": "Dynamite Allumeuse",
    "block.tnts.lava_ocean_dynamite": "Dynamite Océan de Lave",
    "block.tnts.lightning_dynamite": "Dynamite Éclair",
    "block.tnts.lucky_dynamite": "Dynamite Chance",
    "block.tnts.lush_dynamite": "Dynamite Luxuriante",
    "block.tnts.meteor_dynamite": "Dynamite Météore",
    "block.tnts.miningflat_dynamite": "Dynamite Miniage Plate",
    "block.tnts.multiplying_dynamite": "Dynamite Multiplicatrice",
    "block.tnts.nether_grove_dynamite": "Dynamite Bosquet du Nether",
    "block.tnts.nuclear_dynamite": "Dynamite Nucléaire",
    "block.tnts.nuclear_waste_dynamite": "Dynamite Déchets Nucléaires",
    "block.tnts.ocean_dynamite": "Dynamite Océanique",
    "block.tnts.physics_dynamite": "Dynamite Physique",
    "block.tnts.picky_dynamite": "Dynamite Sélective",
    "block.tnts.prism_dynamite": "Dynamite Prisme",
    "block.tnts.pulse_dynamite": "Dynamite Impulsion",
    "block.tnts.rainbow_dynamite": "Dynamite Arc-en-ciel",
    "block.tnts.random_dynamite": "Dynamite Aléatoire",
    "block.tnts.reaction_dynamite": "Dynamite en Réaction",
    "block.tnts.ring_dynamite": "Dynamite Anneau",
    "block.tnts.roulette_dynamite": "Dynamite Roulette",
    "block.tnts.sculk_dynamite": "Dynamite Sculk",
    "block.tnts.sensor_dynamite": "Dynamite Capteur",
    "block.tnts.shatterproof_dynamite": "Dynamite Incassable",
    "block.tnts.snow_dynamite": "Dynamite Neige",
    "block.tnts.sphere_dynamite": "Dynamite Sphérique",
    "block.tnts.spiral_dynamite": "Dynamite Spirale",
    "block.tnts.timer_dynamite": "Dynamite Minuteur",
    "block.tnts.tunneling_dynamite": "Dynamite Tunnelleuse",
    "block.tnts.ultralight_dynamite": "Dynamite Ultralégère",
    "block.tnts.vaporize_dynamite": "Dynamite Vaporisatrice",
    "block.tnts.withering_dynamite": "Dynamite Flétrissante",
    "block.tnts.wool_dynamite": "Dynamite Laine",
    "block.tnts.xray_dynamite": "Dynamite Rayons X",
}
