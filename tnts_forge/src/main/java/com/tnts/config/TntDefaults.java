...
public class TntDefaults {
    ...
    static {
        ...
        add("negra_tnt",     new TntProperties(8.0f,  false, true,  40, of(TntEffect.BLACKHOLE)));
        ...
        // === TNTs MASIVAS NUEVAS ===
        add("terremoto_tnt",  new TntProperties(16.0f, false, true,  60, of(TntEffect.EARTHQUAKE)));  // terremoto masivo
        add("meteorito_tnt",  new TntProperties(14.0f, true,  true,  55, of(TntEffect.METEOR)));    // lluvia de meteoritos
